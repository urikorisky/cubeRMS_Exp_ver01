...
//console.log(stimulus_opacity);
            ...
            if (this.side > 1) {
                ...
                context.drawImage(this.img, stimulus_location-this.width/2, canvas.height/2-this.height/2, this.width, this.height);
            }
...
jsPsych.plugins["rms"] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        setTimeout(function () {
			...
			console.log([trial.stimulus_side,stimulus_side]);
            ...
            let start_trial = function () {
                ...
                startTrialTO = setTimeout(function () {
                    start_time = new Date().getTime();
                    run_animation_loop();
                }, trial.waiting_time * 1000);


                endTrialTO = setTimeout(function () {
                    window.cancelAnimationFrame(animation);
                    frame_context.clearRect(0, 0, frame_canvas.width, frame_canvas.height);
                    end_trial();
